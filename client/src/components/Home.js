...
class Home extends React.Component {
  ...
  handleSearch = async (e) => {
    ...
    await axios
      .get(
        `https://api.foursquare.com/v2/venues/search?client_id=J0QXDNXQGTX5GLM4PVRZ4RGIDFYUFQCXDXT20RLTGOLEYF3B&client_secret=WWGIIVWEVP3KTINZBGFYXDJ1TEGF4ILVLNF4XOBSCS2SYVZH&v=20190819&near=new york&intent=browse&radius=10000&query=${this.state.input}&limit=1`
      )
      .then(async res => {
        console.log(res)
    ...
    const URL = `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=${this.state.input}&location=new york&limit=1`;
    await axios
      .get(URL, {
        params: {},
        headers: {
      ...
      .then(async res => {
        console.log(res)
         await axios.get(`https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/${this.state.yelpVenueID}/reviews`, {
          params: {},
          headers: {
            Authorization:
              "Bearer Mfwm2_zb0qrWMcBjiB3Qw6GSIIG38TS-VdjZepk1X9EvQFw9A9fA24dIzoxyi5Xz4YjBnNnOMb0SGWTuzjTLN4lI9ZDZf9_9Mg7tFPyE8mzapp2y8tnEGbvWH6haXXYx"
  ...
  return (
    <div>
      ...
      <RatingCard yelpData={yelpData} foursquareData={foursquareData} review={review} cardData={cardData} />
